...
if not os.geteuid() == 0:
    sys.exit("\033[1;31mPorniți acest script ca root!\033[0m")
...
print header
print "\033[1;36mSisteme de operare disponibile:\033[1;36m "
print "\n--------------------------"
print "(1) Kali Linux / Ubuntu / Raspbian"
print "--------------------------\n"

option = input("\033[0m[>] Selectați Sistem de operare: \033[0m")
...
if option == 1:
    ...
    print "\033[1;32m[!] Instalare finalizata! Tasteaza 'trity' pentru a rula programul [!]\033[0m"
    sys.exit()
else:
    print "Hopa! Ceva n-a mers bine!"
